...
async function initVendorDetail() {
  ...
  try {
    ...
    const linkedPractices = Array.isArray(vendor.products) ? vendor.products : [];
    const sixmValues = uniqueValues(linkedPractices.flatMap((product) => getDisplaySixM(product)));
